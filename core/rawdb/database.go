...
func NewDatabase(db common.KeyValueStore) common.Database {
	return &nofreezedb{
		KeyValueStore: db,
	}
}
...
// storage.
func NewDatabaseWithFreezer(db common.KeyValueStore, freezer string, namespace string) (common.Database, error) {
...
func NewMemoryDatabase() common.Database {
...
func NewMemoryDatabaseWithCap(size int) common.Database {
	return NewDatabase(memorydb.NewWithCap(size))
}

// NewLevelDBDatabase creates a persistent key-value database without a freezer
// moving immutable chain segments into cold storage.
func NewLevelDBDatabase(file string, cache int, handles int, namespace string) (common.Database, error) {
...
// freezer moving immutable chain segments into cold storage.
func NewLevelDBDatabaseWithFreezer(file string, cache int, handles int, freezer string, namespace string) (common.Database, error) {
...
func InspectDatabase(db common.Database) error {
	it := db.NewIterator()
	defer it.Release()
