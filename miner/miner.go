...
func New(eth Backend, config *Config, chainConfig *params.ChainConfig, mux *core.InterfaceFeed, engine consensus.Engine, isLocalBlock func(block *types.Block) bool) *Miner {
	miner := &Miner{
		eth:      eth,
		mux:      mux,
		engine:   engine,
