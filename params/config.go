...
var (
	...
	GochainDevnetGenesisHash  = common.HexToHash("0x7834f2868a3b60fb24cbb6b66c2da48e275792d01ab3d3f1137106f916ea8230") // Gochain Devnet genesis hash to enforce below configs on
)
...
var (
	...
	// GochainDevnetChainConfig contains the chain parameters to run a node on the Gochain test network.
	GochainDevnetChainConfig = &ChainConfig{
