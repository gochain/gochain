...
func (db *Database) GlobalTable() common.Table  { return db }
func (db *Database) BodyTable() common.Table    { return db }
func (db *Database) HeaderTable() common.Table  { return db }
func (db *Database) ReceiptTable() common.Table { return db }
...
func (db *Database) NewBatch() common.Batch {
	return &batch{
		db: db,
	}
}
...
func (db *Database) NewIterator() common.Iterator {
...
// not exist).
func (db *Database) NewIteratorWithStart(start []byte) common.Iterator {
	db.lock.RLock()
	defer db.lock.RUnlock()
...
func (db *Database) NewIteratorWithPrefix(prefix []byte) common.Iterator {
	db.lock.RLock()
	defer db.lock.RUnlock()
...
func (b *batch) Replay(w common.KeyValueWriter) error {
	for _, keyvalue := range b.writes {
		if keyvalue.delete {
