...
type Sync struct {
	database common.KeyValueReader    // Persistent database to check for existing entries
...
func NewSync(root common.Hash, database common.KeyValueReader, callback LeafCallback, bloom *SyncBloom) *Sync {
	ts := &Sync{
		database: database,
...
func (s *Sync) Commit(dbw common.KeyValueWriter) (int, error) {
