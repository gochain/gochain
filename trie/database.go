...
type Database struct {
	diskdb common.KeyValueStore // Persistent storage for matured trie nodes
...
func NewDatabase(diskdb common.KeyValueStore) *Database {
...
func NewDatabaseWithCache(diskdb common.KeyValueStore, cache int) *Database {
...
func (db *Database) DiskDB() common.KeyValueReader {
	return db.diskdb
}
...
func (db *Database) commit(hash common.Hash, batch common.Batch, uncacher *cleaner) error {
