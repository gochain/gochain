...
func (lc *LightChain) SubscribeLogsEvent(ch chan<- core.ChainSideEvent, name string) {}

func (lc *LightChain) SubscribeRemovedLogsEvent(ch chan<- core.ChainSideEvent, name string) {}
