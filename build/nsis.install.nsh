...
Section "GoChain" GETH_IDX
  ...
  SimpleFC::AdvRemoveRule "GoChain incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "GoChain outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "GoChain UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "GoChain incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "GoChain outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "GoChain UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\geth.exe" "" "" "Ethereum" "" 30303 "" ""
