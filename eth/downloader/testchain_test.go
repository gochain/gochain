...
func (tc *testChain) generate(n int, seed byte, parent *types.Block, heavy bool) {
	...
	blocks, receipts := core.GenerateChain(context.Background(), params.TestChainConfig, parent, clique.NewFaker(), testDB, n, func(ctx context.Context, i int, block *core.BlockGen) {
