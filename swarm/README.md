...
[![Travis](https://travis-ci.org/gochain-io/gochain.svg?branch=master)](https://travis-ci.org/gochain-io/gochain)
...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/gochain-io/gochain

    go install github.com/gochain-io/gochain/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/gochain-io/gochain`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/gochain-io/gochain
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/gochain-io/gochain/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/gochain-io/gochain/wiki/Code-Review-Guidelines).
