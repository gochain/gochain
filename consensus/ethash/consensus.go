...
func (ethash *Ethash) verifyHeaderWorker(ctx context.Context, chain consensus.ChainReader, headers []*types.Header, seals []bool, index int) error {
	...
	return ethash.verifyHeader(ctx, chain, headers[index], parent, false, seals[index])
}
...
func (ethash *Ethash) verifyHeader(ctx context.Context, chain consensus.ChainReader, header, parent *types.Header, uncle bool, seal bool) error {
	...
	expected := ethash.CalcDifficulty(ctx, chain, header.Time.Uint64(), parent)
	...
	if seal {
		if err := ethash.VerifySeal(ctx, chain, header); err != nil {
			return err
		}
	}
...
func (ethash *Ethash) CalcDifficulty(ctx context.Context, chain consensus.ChainReader, time uint64, parent *types.Header) *big.Int {
...
func (ethash *Ethash) VerifySeal(ctx context.Context, chain consensus.ChainReader, header *types.Header) error {
	...
	if ethash.shared != nil {
		return ethash.shared.VerifySeal(ctx, chain, header)
	}
...
func (ethash *Ethash) Prepare(ctx context.Context, chain consensus.ChainReader, header *types.Header) error {
	...
	header.Difficulty = ethash.CalcDifficulty(ctx, chain, header.Time.Uint64(), parent)
	return nil
}

// Finalize implements consensus.Engine, accumulating the block and uncle rewards,
// setting the final state and assembling the block.
func (ethash *Ethash) Finalize(ctx context.Context, chain consensus.ChainReader, header *types.Header, state *state.StateDB, txs []*types.Transaction, uncles []*types.Header, receipts []*types.Receipt, block bool) *types.Block {
